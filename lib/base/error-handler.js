...
(function() {
    const errMsgHdlr = {},
        ErrMsgMap = {
            ...
            "NOT_EXIST_SIMULATOR": "No existing simulator excutable file which name begins with",
            "NOT_SUPPORT_COMMOND_DEPRECATED": "This command is deprecated. Please use \"ares-device\" instead of \"ares-device-info\"",
            "NOT_SUPPORT_COMMOND": "This command does not support by current profile\nIf you want to use this command, please change profile using \"ares-config\" command\nCurrent profile:",
            "NOT_SUPPORT_OPTION": "This option does not support by current profile\nIf you want to use this command, please change profile using \"ares-config\" command\nCurrent profile:",
            ...
            "NOT_PACKAGE_WITH_OPTION": "Cannot package the app with option",
            "NOT_PACKAGE_WITH_PKGDIR": "Cannot package the directory with pkgdir",
            "NOT_PACKAGE_WITH_RESOURCE": "Cannot package app/service with resource",
