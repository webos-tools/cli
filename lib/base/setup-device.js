...
(function() {
    ...
    function displayGetKeyGuide(deviceName) {
        ...
        let webOSName = "TV", guideURL = "https://webostv.developer.lge.com/develop/getting-started/developer-mode-app";
        if(profile === "signage"){
            webOSName = "Signage",
            guideURL = "https://webossignage-docs.developer.lge.com/guides/developer-guides/system-feature/developer-mode";
        }

        const guideSteps = "** To connect to " + webOSName + " you need to do following steps:"
                              + "\n 1. Turning on Developer Mode following this guide: " + guideURL
                              + "\n 2. Launch the Developer Mode app and click the Key Server button in the Developer Mode app"
                              + "\n 3. Get the ssh key file from your webOS " + webOSName + " with the following command on your PC"
