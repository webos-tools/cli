...
(function() {
    ...
    function displayGetKeyGuide(deviceName) {
        ...
        let webOSName = "webOS TV", guideURL = "https://webostv.developer.lge.com/develop/getting-started/developer-mode-app";
        if(profile === "signage"){
            webOSName = "Signage",
            guideURL = "https://webossignage-docs.developer.lge.com/guides/developer-guides/system-feature/developer-mode";
        }

        const guideSteps = "** After adding your device, you'll need to get the key file from your " + webOSName + "."
                              + "\n Follow these steps:"
                              + "\n 1. Ensure that the key server button in the Developer Mode app on your " + webOSName + " is enabled."
                              + "\n 2. Run the command \"ares-novacom --device " + deviceName + " --getkey\" to retrieve the key file from your " + webOSName + "."
                              + "\n 3. Enter the passphrase displayed in the Developer Mode app into the prompt."
                              + "\n For more details, refer to the " + guideURL;
