    ...
    const launcher = {
        ...
        launch: function(options, id, params, next, middleCb) {
            ...
            const self = this,
                ...
                hostedAppId = currentProfile === "signage" ? "com.lg.app.signage.dev" : "com.sdk.ares.hostedapp",
                hostedAppIpkName = currentProfile === "signage" ? "com.sdk.ares.signage.hostedapp" : "com.sdk.ares.hostedapp";
