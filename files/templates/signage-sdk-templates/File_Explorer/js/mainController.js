	    	...
	    	switch(keyCode) { 
		    	...
		    	case BUTTON_OK:
		    		...
		    		if (isRemoveAll) {
		    			...
		    			var removeAll_SuccessCb = function(cbObject) {
		    			...
		    			var removeAll_FaillureCb = function(cbObject) {
		    				document.getElementById('status').innerHTML = "Fail to remove all data : " + RemoveAllDevice;
		    				listFile_in_CurrentFolder(current_path);
		    			}
		    			
		    			var removeAll_options = {
		    					device : RemoveAllDevice
		    			}
		    			storage.removeAll(removeAll_SuccessCb, removeAll_FaillureCb, removeAll_options);
		    		}
		    		else {
		    			current_mode = MODE_EXPLORER;
				    	isPopupExists = false;
	    ...
	    // Mkdir Mode
	    	...
	    	case BUTTON_OK: 	    		
	    		if (isMkdir) {
	    			...
	    			var storage = new Storage();	    			
	    			var mkdir_SuccessCb = function(cbObject) {
	    			...
	    			var mkdir_FaillureCb = function(cbObject) {
	    			...
	    			storage.mkdir(mkdir_SuccessCb, mkdir_FaillureCb, mkdir_options);
	    		}
	    		else {
	    			current_mode = MODE_EXPLORER;
			    	isPopupExists = false;
